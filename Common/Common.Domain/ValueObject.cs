...
// های لازم برای جمع و تفریق و غیره را میسازیم و Operator داخل این کلاس
// پیاده سازی کنن Operator های ما میان از این کلاس ارث بری میکنن تا لازم نباشه هربار Value Object کلاس
