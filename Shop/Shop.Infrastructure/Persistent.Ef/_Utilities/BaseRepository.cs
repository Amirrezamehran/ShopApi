...
namespace Shop.Infrastructure.Persistent.Ef._Utilities
{

    // هست دیگه لازم نیست آن را به صورت جنریک Shop.Infrastructure چون کانتکست داخل همین
    // بگیریم. ولی اگر کانتکست داخل جای دیگری تعریف شده بود BaseRepository در ورودی کلاس
    // باید یک کانتکست هم به صورت جنریک واسه این کلاس دریافت میکردیم
