...
namespace Shop.Infrastructure.Migrations
{
    ...
    [Migration("20260601141831_Change_Setting_Migration")]
    partial class Change_Setting_Migration
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Shop.Domain.CategoryAggregate.Category", b =>
                {
                    ...
                    b.OwnsOne("Shop.Domain.ProductAggregate.ValueObjects.SeoData", "SeoData", b1 =>
                        {
            ...
            modelBuilder.Entity("Shop.Domain.OrderAggregate.Order", b =>
                {
                    ...
                    b.OwnsOne("Shop.Domain.OrderAggregate.ValueObjects.OrderDiscount", "Discount", b1 =>
                        {
                            b1.Property<long>("OrderId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsOne("Shop.Domain.OrderAggregate.ValueObjects.OrderShippingMethod", "ShippingMethod", b1 =>
                        {
                            b1.Property<long>("OrderId")
                                .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shop.Domain.ProductAggregate.Product", b =>
                {
                    ...
                    b.OwnsMany("Shop.Domain.ProductAggregate.ProductImage", "Images", b1 =>
                        {
                            b1.Property<long>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("bigint");
