...
// داریم www.root ها استفاده میکنه و داخل اون پروژه فایل Api ما میاد از این Razor Page چون پروژه
// که داخلش عکس و چیزهای دیگمونو قرار میدیم اومدیم برای اینم تابع زیر رو فعال کردیم تا وقتی اون پروژه میخواد
// عکس بگیره بفرسته یا از این دست کارا بکنه مشکلی نداشته باشه و خطا نده
app.UseStaticFiles();
